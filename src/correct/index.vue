      ...
      <div class="panel-content">
        <div class="step">
          <el-steps :space="350" :active="current" finish-status="success" align-center>
            ...
            <el-step title="冲正页面"></el-step>
            <el-step title="冲正成功"></el-step>
          </el-steps>
        </div>
        ...
        <div class="charge-content" v-if="current == 1">
          ...
          <div class="item">
            ...
            <el-input class="value" v-model="charge.tranNo"/>
          </div>
          <div class="item">
...
export default {
  ...
  methods: {
    ...
    recharge () {
      ...
      this.$api.correctRecharge(this.charge)
        .then(
          res => {
            this.charge.apiHost = ''
            if (res.ack) {
